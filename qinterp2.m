% The function qinterp2 is provided in the matlab forum as an alternative to the 
% standard qinterp that is built in in the matlab suite. 
% qinterp2 is faster than qinterp (by orders of magnitude)
